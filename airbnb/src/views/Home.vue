  ...
  <div class="home">
    <div>
      ...
      <div>
        ...
        <div class="slide">
          <div @click="selectedCity(index)" v-for="(city,index) in cityArr" :key="index"
        ...
        <div class="global-room-block normal-block" >
          <div style="padding-bottom: 5px" class="global-room" v-for="(story,index) in travelStories" :key="index">
            <div class="use-background" :style="{backgroundImage: `url(${story.imgURL})`}"></div>
            <div class="city-intro" style="padding: 8px 0 4px 0;font-weight: 300"><span class="city-name">{{story.cityName}}</span> {{story.title}}</div>
            <div style="display: flex;align-items: center;margin-bottom: 12px">
              <svg viewBox="0 0 16 16" role="img" aria-label="“赞”的数量" focusable="false" style="height:12px;fill:#767676">{<!-- -->/* If you update this, update thumbs-up-alt-mirror.svg too */<!-- -->}<path d="m14.5 7.63c0-.97-.8-1.63-2-1.63l-4.5.01c.04-.05.11-.12.2-.21.39-.4 1.04-1.06 1.41-1.87.31-.68.46-1.61.37-2.32-.09-.65-.59-1.61-1.61-1.61-.44 0-1.23.2-1.6 1.52a3.12 3.12 0 0 0 -.05.22c-.14.62-.44 1.93-3.11 2.86-2.4.82-3.61 2.81-3.61 5.9 0 3.44 1.98 5.5 5.3 5.5h6.2c1.2 0 2-.65 2-1.63 0-.33-.09-.64-.24-.89.62-.34.74-.94.74-1.36a1.66 1.66 0 0 0 -.24-.9c.65-.37.74-1.01.74-1.35 0-.28-.06-.77-.45-1.14.29-.28.45-.66.45-1.11"></path></svg>
              <span style="font-weight: 300;font-size: 12px;line-height: 18px;margin-left: 3px">{{story.likeNum}}</span>
              <svg viewBox="0 0 16 16" role="img" aria-label="评论数量" focusable="false" style="height:12px;margin-left:8px;fill:#767676">{<!-- -->/* If you update this, update comment-alt-mirror.svg too */<!-- -->}<path d="m4.5 7h4c .28 0 .5.23.5.5s-.22.5-.5.5h-4c-.28 0-.5-.23-.5-.5s.22-.5.5-.5m-.5-2.5c0-.28.22-.5.5-.5h7c .28 0 .5.23.5.5s-.23.5-.5.5h-7c-.28 0-.5-.23-.5-.5m8.5-3.5h-9c-1.38 0-2.5 1.12-2.5 2.5v12c0 .25.18.45.42.49.03.01.05.01.08.01.21 0 .41-.14.47-.34.56-1.69 2.74-3.66 7.03-3.66h3.5c1.38 0 2.5-1.12 2.5-2.5v-6c0-1.38-1.12-2.5-2.5-2.5"></path></svg>
              <span style="font-weight: 300;font-size: 12px;;margin-left: 3px">{{story.commentNum}}</span>
            </div>
          </div>
        </div>
        <div
        ...
        <div class="normal-block" style="display: flex;justify-content: space-between;padding: 25px 0;margin-top:30px;border-top: 1px solid #e7e7e7;flex-wrap: wrap">
          ...
          <select style="margin-bottom: 20px" name="language" class="language-select" preval="CNY 人民币">
  ...
  export default {
    ...
    data(){
      return{
        ...
        travelStories:[
                {
            imgURL: 'https://z1.muscache.cn/im/pictures/c6a66b67-57d4-4206-90b9-82d94329762a.jpg?aki_policy=x_large',
            cityName: '广州',
            title: '房东说，欢迎体验你的 “珠江之夜”。',
            likeNum: '49',
            commentNum: '3'
          }, {
            imgURL: 'https://z1.muscache.cn/im/pictures/694ef74b-4caf-4a10-98c4-78215bf0fb6c.jpg?aki_policy=x_large',
            cityName: '广州',
            title: '房东说，欢迎体验你的“珠江之夜”。',
            likeNum: '49',
            commentNum: '3'
          },{
            imgURL: 'https://z1.muscache.cn/im/pictures/41d3443a-97bf-401b-9acc-c5ba9ef1bf5e.jpg?aki_policy=x_large_portrait',
            cityName: '广州',
            title: '房东说，欢迎体验你的 “珠江之夜”。',
            likeNum: '49',
            commentNum: '3'
          },{
            imgURL: 'https://z1.muscache.cn/im/pictures/ed07ac15-ea02-4b73-8ada-9e511618f9dd.jpg?aki_policy=x_large_portrait',
            cityName: '广州',
            title: '房东说，欢迎体验你的 “珠江之夜”。',
            likeNum: '49',
            commentNum: '3'
        ...
        experienceArr: [
          {
            imgURL:'https://z1.muscache.cn/im/pictures/f61fb2a1-bd9e-4f05-ae0f-ad1194676efb.jpg?aki_policy=large',
            country: '葡萄牙',
            title: '里斯本极品美食',
            price:'每人 ¥484',
            score: [4.99,1442]
          ...
          {
            imgURL:'https://z1.muscache.cn/im/pictures/2f690952-a2e3-47bc-8736-b98ec3ba60c4.jpg?aki_policy=large',
            country: '日本',
            title: '日本武士之魂',
            price:'每人 ¥484',
            score: [4.99,1442]
          ...
          {
            imgURL:'https://z1.muscache.cn/im/pictures/354171df-e840-4310-a12b-bc8562c4398f.jpg?aki_policy=large',
            country: '法国',
          ...
          {
            imgURL:'https://z1.muscache.cn/im/pictures/7af6b5b6-03ac-42a5-8385-76c1cc986988.jpg?aki_policy=large',
            country: '哥伦比亚',
            title: '哥伦比亚安第斯山骑马之旅',
            price:'每人 ¥484',
            score: [4.99,1442]
