<template>
    <div>
        <div @click="searchCity()" class="search-container" style="display: flex;align-items: center">
        ...
        <div @click="searchCity()" class="fixed-search" style="position: fixed;top:0;width: 100%;background-color: white;padding: 15px 0;display: none">
