<template>
    <div>
        <div class="header-box">
            ...
            <div @click="openUserBar" style="display:block;height: 32px">
                <img
                        style="height:100%;"
                        src="https://z1.muscache.cn/pictures/a9eb74b8-51a7-4059-a52a-f2a39d3b86fd.jpg"
                        alt
                        width="32px"
                        height="32px"
                />
        ...
        <div @click="handleClick">
            <user-folder :userDoc="userDoc" v-if="isChecking" />
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        name: "IndexHeader",
        components: { UserFolder, IndexSearching },
        data() {
            return {
                presents: [
                    {
        ...
        methods: {
            changeContainer() {
                this.interval = setInterval(() => {
                    try {
                        ...
                        if (!dash) {
                            preDash = document.getElementsByClassName("dash")[
                            this.activeDash - 1
                                ];
                            this.activeDash = 0;
            ...
            handleClick(e) {
                if (e.layerX <= window.innerWidth * 0.3) {
